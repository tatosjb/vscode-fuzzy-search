...
complete -c fd -n "__fish_use_subcommand" -l path-separator -d 'Set the path separator to use when printing file paths.'
...
complete -c fd -n "__fish_use_subcommand" -l regex -d 'Perform a regex-based search'
